...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    //ENTITIES
	    AABB testBox = new AABB(new Vector3f(0,0,0), new Vector3f(1,1,1));
...
//	    }
	    ...
	    while(!Display.isCloseRequested()) {
			...
			if(Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
				Projectile bullet = new Projectile(lampModel, new Vector3f(player.getPosition()), testBox,0, 0, player.getrY(), 0, 1f);
