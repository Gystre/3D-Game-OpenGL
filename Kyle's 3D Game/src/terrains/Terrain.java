...
public class Terrain {
	...
	//position in world modify y value to create height in the terrain
	private float x;
	private float z;
	...
	private float getHeight(int x, int y, BufferedImage image) {
		...
		height /= MAX_PIXEL_COLOR/2f; //to get a number between -1 and 1
		height *= MAX_HEIGHT;
	...
	public float getHeightOfTerrain(float worldX, float worldZ) {
		...
		//get player's position in grid (x, z)
